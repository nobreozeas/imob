...
function submeter() {
    form.post(route('financeiro.lancamentos.receitas.store'), {
...
<template>
    <dialog class="modal modal-open">
        <div class="modal-box">
            <h3 class="font-bold text-lg mb-4">Nova Receita</h3>
            <form @submit.prevent="submeter" class="space-y-4">
                ...
                <div class="form-control">
                    ...
                    <select v-model="form.status" class="select select-bordered">
                        ...
                        <option value="pago">Já recebida</option>
                    </select>
                </div>
                <div v-if="form.status === 'pago'" class="grid grid-cols-2 gap-4">
                    <div class="form-control">
                        <label class="label"><span class="label-text">Data do recebimento *</span></label>
                    ...
                    <div class="form-control">
                        <label class="label"><span class="label-text">Forma de recebimento *</span></label>
