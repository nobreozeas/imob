...
class StoreDespesaFinanceiraRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'categoria_financeira_id' => [
                'required', 'uuid',
                Rule::exists('categorias_financeiras', 'id')->where('ativa', true)->where('tipo', CategoriaFinanceira::TIPO_SAIDA),
            ],
