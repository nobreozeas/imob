# imovel-midias Specification

## Purpose

Permitir o gerenciamento incremental de fotos e documentos de um imóvel já cadastrado (upload, remoção e definição de foto principal), sem exigir o preenchimento do formulário completo de edição.
